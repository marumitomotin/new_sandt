...
<div class="container">
  ...
  <div class="content-area">
    ...
    <section id="introduction">
      ...
      <h3 class="shippori" style="line-height:1;margin-bottom:0;">そして、その考え方とは</h3>
    </section>
    ...
    <section id="merit">
      <p style="text-align:center;margin-bottom:25px;">
        <span class="btn-fill-green" style="pointer-events:none;">PM導入の目的とメリット</span>
      </p>

      <table class="sp-hide-table">
        <tr>
      ...
      <table class="sp-show-table" style="margin-bottom:20px;">
        <tr>
          <th style="background:#e9fbe5;color:#000000;">目的</th>
        </tr>
        <tr>
    ...
    <section id="scheme">
      <p style="margin-bottom:25px;">
        <span class="btn-fill-green" style="pointer-events:none;">PM導入の基本スキーム</span>
      </p>
      <img src="<?=$r?>/images/service/scheme.png" class="sp-hide" alt="PM導入の基本スキーム">
      <img src="<?=$r?>/images/service/scheme_sp.png" class="sp-show" alt="PM導入の基本スキーム">
    </section>

    <section id="work">
      <p style="margin-bottom:25px;text-align:center;">
        <span class="btn-fill-green" style="pointer-events:none;">管理実績</span>
      </p> <?php
      query_posts([
    ...
    <section id="broker">
      ...
      <table class="sp-hide-table" style="margin-bottom:20px;">
        <tr>
    ...
    <section id="rent">
      ...
      <p style="margin:40px auto 25px auto;text-align:center;">
        <span class="btn-fill-green" style="pointer-events:none;">自社物件</span>
      </p> <?php
      query_posts([
        'post_type' => 'chintai',
        'posts_per_page' => '3',
    ...
    <section id="howto">
      ...
      <p style="margin:40px auto 25px auto;text-align:center;">
        <span class="btn-fill-green" style="pointer-events:none;">土地活用実績</span>
      </p>  <?php
      query_posts([
        'post_type' => 'tochi',
        'posts_per_page' => '4',
    ...
    <section style="margin-bottom:70px;padding:0;">
      <P style="font-size:18px;font-weight:bold;color:#467065;margin-bottom:15px;">概要例</p>
      <p style="margin:20px 0;">
        <span class="btn-fill-green" style="pointer-events:none;">有効活用</span>
      </p>
      ...
      <p style="margin:20px 0;">
        <span class="btn-fill-green" style="pointer-events:none;">相続対策（売却・購入・交換）</span>
      </p>
      <p class="standard-p" style="margin-bottom:22px;">
      ...
      <p style="margin:20px 0;">
        <span class="btn-fill-green" style="pointer-events:none;">権利関係の調査・整理</span>
      </p>
      <p class="standard-p" style="margin-bottom:22px;">
        借地・借家・境界・共用持分等の複雑な権利関係を調査し、スムーズな解決をご提案致します。
      </p>
      <p style="margin:20px 0;">
        <span class="btn-fill-green" style="pointer-events:none;">収益物件の購入・管理</span>
      </p>
      <p class="standard-p" style="margin-bottom:22px;">
  ...
  <div id="right-sidebar" class="right-sidebar">
    <p>
      <span id="word-introduction">
        <a href="#introduction" style="color:inherit;">不動産賃貸管理業</a>
      </sapn>
    ...
    <p>
      <span id="word-broker">
        <a href="#broker" style="color:inherit;">不動産仲介業</a>
      </span>
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <p>
      <span id="word-rent">
        <a href="#rent" style="color:inherit;">不動産賃貸業</a>
      </span>
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <p>
      <span id="word-howto">
        <a href="#howto" style="color:inherit;">土地活用</a>
      </span>
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <p>
      <span id="word-consulting">
        <a href="#consulting" style="color:inherit;">不動産コンサル</a>
      </span>
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
