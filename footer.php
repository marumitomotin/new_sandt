        ...
        <div class="container">
          ...
          <div class="row" style="margin:0;">
            ...
            <div class="right-side left-item">
              ...
              <a href="https://www.instagram.com/sandt_group?utm_source=qr" target="_blank">
      ...
      <?php if (is_page('kaiyaku') || is_page('park-kaiyaku')) {?>
        jQuery(function($) {
          ...
          opt.beforeShow = function(input, inst) {
            setTimeout(function() {
              var currentTop = parseInt(inst.dpDiv.css("top"));
              inst.dpDiv.css("top", currentTop - 100 + "px"); // ヘッダー高さ分引く
            }, 1);
          };

          opt2.beforeShow = function(input, inst) {
            setTimeout(function() {
              var currentTop = parseInt(inst.dpDiv.css("top"));
              inst.dpDiv.css("top", currentTop - 100 + "px"); // ヘッダー高さ分引く
            }, 1);
