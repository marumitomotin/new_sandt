...
?>
 ...
              <p style="font-size:18px;font-weight:bold;">全管協少額短期保険</p>
      ...
      <section id="section_renew" style="padding-bottom:65px;">

        <h3 class="title-back-square" style="padding-bottom:16px;">更新について</h3>

        <p class="green-bold-16" style="margin-bottom:0;">更新⼿続きを⾏う場合は「賃貸物件マイページ」のご登録が必要です。</p>

        <div style="max-width:450px;margin:50px auto;">

          <p style="font-size:16px;font-weight:bold;margin-bottom:20px;">▶︎マイページに登録済の⽅はこちらから</p>
          <a href="https://taikyokun.com/tenants/login" target="_blank">
            <div style="width:100%;height:80px;border:2px solid #467065;display:flex;align-items:center;justify-content:center;margin-bottom:60px;">
              <p style="color:#467065;font-weight:bold;font-size:18px;">マイページにログイン</p>
            </div>
          </a>

          <p style="font-size:16px;font-weight:bold;margin-bottom:20px;">▶︎まだマイページに登録していない⽅はこちらから</p>
          <a href="https://taikyokun.com/publics/invite_applications?&token=eb67939cbb98" target="_blank">
            <div style="width:100%;height:80px;border:2px solid #467065;display:flex;align-items:center;justify-content:center;">
              <p style="color:#467065;font-weight:bold;font-size:18px;">マイページ 新規ご登録URLの送信</p>
            </div>
          </a>
        ...
        <div style="margin-bottom:30px;">
          ...
          <p style="font-weight:bold;">●契約内容のご確認</p>
          <p style="font-weight:bold;">●⼊居者様情報の確認・変更</p>
          <p style="font-weight:bold;">●チャットによるお問い合わせ</p>
        </div>
        ...
        <p>■<a href="https://rentee-itandi.zendesk.com/hc/ja" target="_blank" style="color:#1247D9;text-decoration:underline;">ヘルプページ</a></p>
      ...
      <section id="section6" style="padding-bottom:65px;">
        ...
        <p class="standard-p" style="margin-bottom:40px;">
          ...
          ●詳細はパンフレットをご覧ください → <a href="https://sandt-inc.co.jp/wp-content/uploads/2024/03/st_new_nyuky_240303_ol.pdf" target="_blank" style="color:#1247D9;">こちらへ</a>
        </p>
      ...
      <section id="section_contact">
        ...
        <h3 class="title-back-square" style="padding-bottom:16px;">お問い合わせ窓口</h3>

        <p class="standard-p" style="margin-bottom:30px;">お困り事がございましたら、下記のいずれかよりお問い合わせください。</p>

        <div style="font-weight:bold;font-size:18px; margin-bottom:95px;">
          <p style="margin-bottom:10px;">〇チャット：<a href="https://taikyokun.com/tenants/login" style="color:#1247D9;">「賃貸物件マイページ」</a>からお問い合わせください。</p>
          <p style="margin-bottom:10px;">〇Webフォーム：<a href="/contact/" style="color:#1247D9;">こちら</a>からお問い合わせください。</p>
          <p style="margin-bottom:10px;">〇電話：048-433-0550 （営業時間：10：00〜18：00 定休⽇：⽔曜⽇・⽇曜⽇）</p>
        </div>
