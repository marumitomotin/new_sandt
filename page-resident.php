  ...
  <div class="content-area">
    ...
    <section id="cancel" style="border-bottom:none;padding-bottom:0;">
      ...
      <div class="box">
        ...
        <a href="/kaiyaku/" class="btn-fill-green">
          <span>解約申請フォームはこちらから</span>
          <img src="<?=$r?>/images/common/arrow_fat_white.svg" class="fill-green-hover" alt="矢印">
        </a>
        <a href="/wp-content/uploads/2021/04/kaiyaku.pdf" class="btn-fill-green" target="_blank">
      ...
      <div class="box">
        ...
        <a href="/wp-content/uploads/2021/04/kaiyaku_car.pdf" class="btn-fill-green" target="_blank">
    ...
    <section id="renew">
      ...
      <div class="row">
        <div class="col-liq-6">
          ...
          <a href="https://taikyokun.com/tenants/login" class="btn-fill-green" target="_blank">
            ログイン
            <img src="<?=$r?>/images/common/arrow_fat_white.svg" class="fill-green-hover" alt="矢印">
          </a>
        </div>
    ...
    <section id="manner" style="padding-bottom:65px;">
    ...
    <section id="living" style="padding-bottom:65px;">
